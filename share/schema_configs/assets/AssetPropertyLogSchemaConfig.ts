...
import {AssetPropertyLog} from "../../types/DatabaseTypes";
import _ from "lodash";
export const AssetPropertyLogSchemaConfig: ISchemaConfig<AssetPropertyLog> = {
    name:"Asset Property Log",
    importKeys:[],
    exportKeys:[],
    uniqueKeys:[],
    searchKeys:[],
    ...
    fieldConfigs:{
        ...
        document:{type:SCHEMA_TYPE.ASSET_PROPERTY,label:"Document"},
