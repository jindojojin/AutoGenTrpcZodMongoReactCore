...
import {AssetInvoiceLog} from "../../types/DatabaseTypes";
import _ from "lodash";
export const AssetInvoiceLogSchemaConfig: ISchemaConfig<AssetInvoiceLog> = {
    name:"Asset Invoice Log",
    importKeys:[],
    exportKeys:[],
    uniqueKeys:[],
    searchKeys:[],
    ...
    fieldConfigs:{
        ...
        document:{type:SCHEMA_TYPE.ASSET_INVOICE,label:"Document"},
