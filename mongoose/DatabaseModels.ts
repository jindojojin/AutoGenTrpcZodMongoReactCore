...
import {
    AssetCategoryLogMongooseSchema,
    AssetCategoryMongooseSchema,
    AssetInvoiceLogMongooseSchema,
    AssetInvoiceMongooseSchema,
    AssetLogMongooseSchema,
    AssetMongooseSchema,
    AssetPicLogMongooseSchema,
    AssetPicMongooseSchema,
    AssetPropertyLogMongooseSchema,
    AssetPropertyMongooseSchema,
    PlmCodeMongooseSchema,
    PlmDefectMongooseSchema,
    ProjectMongooseSchema,
    ScopeMongooseSchema,
    TaskCheckItemMongooseSchema,
    TaskMongooseSchema,
    TestProjectMongooseSchema,
    Ttv2TestcaseMongooseSchema,
    Ttv2TestSetMongooseSchema,
    Ttv2TestSuiteMongooseSchema,
    UserMongooseSchema,
